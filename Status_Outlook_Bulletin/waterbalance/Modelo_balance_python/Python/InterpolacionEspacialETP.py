# InterpolacionEspacialETP.py

import numpy as np
import pandas as pd
import time

def funcion_interpolacion_etp():
    ...
    Pcuen_df.to_csv('ETPmedias.csv', index=False, header=True)
    ...
    print(f"Tiempo de ejecución interpolacion ETP: {tiempo_ejecucion} segundos")
