#este script converte los datos de caudal descargados de UTE al formato de entrada de datos de caudal del MGB

import datetime

# Ruta al archivo local
archivo = 'C:/Users/tiago/OneDrive/Área de Trabalho/Dinagua/MGB/Yi2/Caudal/testeCaudal1.txt'
...
for fecha, precipitacion in resultados:
    if fecha is not None:
        try:
            ...
            output_resultados.append(f"{day.rjust(6)} {month.rjust(5)} {year.rjust(5)} {str(precipitacion).rjust(8)}.000000")
...
archivo_salida = 'C:/Users/tiago/OneDrive/Área de Trabalho/Dinagua/MGB/Yi2/Caudal/testeCaudal2.txt'
