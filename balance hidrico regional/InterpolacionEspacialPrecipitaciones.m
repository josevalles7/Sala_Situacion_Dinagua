% función que interpola precipitaciones por cuenca en base a datos 
% pluviometricos e inversa de la distancia al cuadrado
    ...
    for j=1:ncols % es la coordenada x
        if cuenca(i,j)>0 %si está dentro de la cuenca determino las distancias desde el punto a los pluvsj
            ...
            for k=1:ndias
                ...
                y=sortrows(y,2); %las oredeno junto a sus codigos
...
% save Pmedias.csv Pcuen -ascii
csvwrite('Pmedias.csv',Pcuen)
