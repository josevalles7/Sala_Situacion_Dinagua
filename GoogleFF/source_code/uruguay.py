...
# attributes.
SHAPEFILE_PATH = os.path.join(WORKING_DIRECTORY, 'test_basin_shapefile.geojson')

# Path to our internal gauge information file from ingesting the streamflow
# data
GAUGE_INFO_PATH = os.path.join(WORKING_DIRECTORY, 'gauges_info_lev12.csv')
...
MODEL_RUN_DIRECTORY = os.path.join(WORKING_DIRECTORY, 'model_runs')
...
ATTRIBUTES_FILE = os.path.join(WORKING_DIRECTORY, 'basin_attributes.csv')

GLOBAL_GAUGE_GROUP_FILE = os.path.join(WORKING_DIRECTORY, 'global_gauge_group.csv')
# ------------------------------------------------------------------------------
# DATA PATHS
# ------------------------------------------------------------------------------
